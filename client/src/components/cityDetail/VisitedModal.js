...
class VisitedModal extends Component {
  ...
  render() {
    if (this.props.cityFormSuccess)
      return <Redirect to={`/memories/${this.props.memory_id}`} />;
    return (
      <>
        <Button className="m-3" variant="info" onClick={this.handleShow}>
          <FontAwesomeIcon icon={faImages} />
          <span className="md-hidden d-inline">
            {" "}
            Visited? Create trip album
          </span>
        </Button>
        <Modal
        ...
        >
          ...
          <Modal.Body>
            <form
              ...
              className="login-form ml-3 mr-3"
            >
              <div className="form-group row p-1 m-0">
                <label htmlFor="fromDate" className="col-3 col-form-label p-0">
                  From Date:{" "}
                </label>
                <div className="col-9">
                  <input
              ...
              <div className="form-group row p-1 m-0">
                <label htmlFor="toDate" className="col-3 col-form-label p-0">
                  To Date:{" "}
                </label>
                <div className="col-9">
                  <input
              ...
              <div className="form-group row p-1 m-0">
                <label
                  htmlFor="travellersNum"
                  className="col-8 col-form-label p-0"
                >
                ...
                <div className="col-4">
                  <input
                    onChange={this.handleChange}
                    value={this.state.travellersNum}
                    className="form-control"
                    name="travellersNum"
                    type="number"
                    min={0}
              ...
              <div className="form-group row p-1 m-0">
                <label htmlFor="cost" className="col-7 col-form-label p-0">
                  Actual Cost (€)
                </label>
                <div className="col-5">
                  <input
              ...
              <div className="form-group">
                <label htmlFor="summary">
                  Your short summary about the trip
                </label>
                <textarea
                  onChange={this.handleChange}
              ...
              <div className="form-group row">
                <label htmlFor="rating" className="col-8">
                  Rate your trip
                </label>
                <div className="col-4">
                  <select
              ...
              <div className="form-group text-center">
                <button type="submit" className="btn btn-city">
                  Submit Your Trip
                </button>
              </div>
            </form>
